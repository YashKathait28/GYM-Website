...
const Button = (props) => {
  return (
    <div>
      <button className="relative inline-flex items-center justify-start px-5 py-3 overflow-hidden font-bold rounded-full group bg-brightRed hover:bg-red-700 transition-colors duration-300">
